        ...
        inManagedObjectContext:(NSManagedObjectContext *)context
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:@"unique = %@", [tweetInfo objectForKey:@"id_str"]];
    ...
    if (!matches || ([matches count] > 1)) {
        ...
        tweet.whoWrote = [User userWithUsername:[[tweetInfo objectForKey:@"user"] objectForKey:@"screen_name"] name:[[tweetInfo objectForKey:@"user"] objectForKey:@"name"] inManagedObjectContext:context];
    } else {
