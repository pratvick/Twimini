        ...
        inManagedObjectContext:(NSManagedObjectContext *)context
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:@"unique = %@",
                         [timelineInfo objectForKey:@"id_str"]];
    ...
    if (!matches || ([matches count] > 1)) {
        ...
        timeline = [NSEntityDescription insertNewObjectForEntityForName:@"NewsFeed"
        ...
        timeline.whoseFeed = [User userWithUsername:username
                                               name:name
                             inManagedObjectContext:context];
    } else {
